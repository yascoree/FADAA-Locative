"""create blog_posts table and seed existing articles

Revision ID: 80c46c1020e2
Revises: 37a1fac47f59
...
revision: str = '80c46c1020e2'
down_revision: Union[str, Sequence[str], None] = '37a1fac47f59'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


blog_post_status = sa.Enum("DRAFT", "PUBLISHED", name="blog_post_status")
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("statut", blog_post_status, nullable=False, server_default="DRAFT"),
        sa.Column("published_at", sa.DateTime(), nullable=True),
        sa.Column("author_id", sa.Integer(), sa.ForeignKey("utilisateurs.id"), nullable=True),
...
ARTICLES = [
    {
        ...
        "description": "Comprendre la gestion locative au Maroc : obligations légales, encaissement des loyers, relation avec les locataires et comment un logiciel de gestion locative simplifie chaque étape.",
        "keywords": ["gestion locative Maroc", "gestion immobilière", "agence immobilière"],
        "published_at": "2026-06-02",
        "reading_time": "7 min",
        "excerpt": "Que vous soyez propriétaire d'un seul appartement ou agence gérant plusieurs dizaines de biens, la gestion locative au Maroc suit les mêmes fondamentaux. Voici comment les maîtriser.",
        "content": [
    ...
    },
    {
        ...
        "description": "Les critères essentiels pour choisir un logiciel de gestion locative adapté à votre situation : propriétaire individuel ou agence immobilière, fonctionnalités clés, sécurité des paiements.",
        "keywords": ["logiciel de gestion locative", "gestion locative Maroc", "gestion immobilière"],
        "published_at": "2026-06-16",
        "reading_time": "6 min",
        "excerpt": "Tous les logiciels de gestion locative ne se valent pas. Voici les critères à vérifier avant de choisir celui qui accompagnera votre activité au quotidien.",
        "content": [
    ...
    },
    {
        ...
        "description": "Les mentions obligatoires d'un bail de location au Maroc, la durée, le dépôt de garantie, et comment un logiciel de gestion locative facilite le suivi du contrat après signature.",
        "keywords": ["bail de location", "gestion locative Maroc", "gestion immobilière"],
        "published_at": "2026-07-03",
        "reading_time": "5 min",
        "excerpt": "Le bail de location est le socle de toute relation entre propriétaire et locataire. Voici ce qu'il doit contenir, et comment en assurer le suivi une fois signé.",
        "content": [
    ...
    },
    {
        ...
        "description": "Retards de loyer, quittances, relances : les bonnes pratiques pour sécuriser le paiement du loyer et automatiser le recouvrement grâce à un logiciel de gestion locative.",
        "keywords": ["paiement du loyer", "gestion locative Maroc", "logiciel de gestion locative"],
        "published_at": "2026-07-21",
        "reading_time": "6 min",
        "excerpt": "Le paiement du loyer est le nerf de la gestion locative. Voici comment réduire les retards et supprimer la charge administrative liée aux quittances.",
        "content": [
    ...
    },
    {
        ...
        "description": "Les défis spécifiques d'une agence immobilière qui gère le patrimoine de plusieurs propriétaires, et comment structurer équipe, mandats et permissions pour rester organisé.",
        "keywords": ["agence immobilière", "gestion immobilière", "gestion locative Maroc"],
        "published_at": "2026-08-05",
        "reading_time": "6 min",
        "excerpt": "Gérer un bien pour un client est simple. En gérer des dizaines pour plusieurs propriétaires, avec une équipe, exige une vraie structure. Voici comment l'organiser.",
        "content": [
...
def _seed_existing_articles():
    ...
    blog_posts_table = sa.table(
        ...
        sa.column("reading_time", sa.String),
        sa.column("statut", blog_post_status),
    ...
    rows = [
        {
            ...
            "content_html": _render_html(article["content"]),
    ...
    conn.execute(blog_posts_table.insert(), rows)


def downgrade() -> None:
    op.drop_index("ix_blog_posts_slug", table_name="blog_posts")
    op.drop_table("blog_posts")
    blog_post_status.drop(op.get_bind(), checkfirst=True)
