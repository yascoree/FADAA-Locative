    ...
    <div>
      ...
      <div className={styles.section}>
        <div className={styles.statsGrid}>
          <StatCard icon="bi-receipt" tone="primary" label={t("bo.agencePaiements.statCount")} value={stats.count} />
      ...
      <div className={styles.section} style={{ marginBottom: 0 }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <h2 className={styles.sectionTitle}>
              ...
              {t("bo.agencePaiements.title")}
            </h2>
            <p className={styles.sectionSubtitle}>
              {t("bo.agencePaiements.subtitle", { shown: filteredPaiements.length, total: paiements.length })}
            </p>
          </div>
          <button
            type="button"
            ...
            title={locatairesWithEcheances.length === 0 ? t("bo.agencePaiements.noEligibleTenant") : undefined}
          >
        ...
        {locatairesWithEcheances.length === 0 && (
          <p className={styles.empty}>{t("bo.agencePaiements.noEligibleTenant")}</p>
        )}
                    ...
                    {(() => {
                      ...
                      return (
                        <div className={styles.tableActions}>
                          ...
                          {p.statut !== PAIEMENT_STATUS.ANNULE && !p.encaisse && canUpdate && (
                            <button
                              type="button"
                              className={styles.iconBtn}
      ...
      <Modal isOpen={createOpen} onClose={closeCreate} title={t("bo.proprietairePaiements.createTitle")}>
        <form onSubmit={handleSubmitCreate}>
          ...
          <SelectField
            ...
            hint={t("bo.agencePaiements.tenantHint")}
            required
          />
