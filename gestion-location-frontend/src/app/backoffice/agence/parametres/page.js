...
export default function AgenceParametresPage() {
  ...
  async function handleSubmitProfile(e) {
    ...
    try {
      ...
      setProfileBanner({ type: "success", message: t("bo.agenceParametres.profileUpdated") });
    } catch (err) {
  ...
  async function handleSubmitAccount(e) {
    ...
    try {
      ...
      await refreshUser();
      setAccountBanner({ type: "success", message: t("bo.agenceParametres.accountUpdated") });
    } catch (err) {
    ...
    <div>
      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>
          ...
          {t("bo.agenceParametres.title")}
        </h2>
        <p className={styles.sectionSubtitle}>{t("bo.agenceParametres.subtitle")}</p>
      </div>
