  ...
  useEffect(() => {
    async function init() {
      ...
      try {
        ...
        const [lotsList, biensList, categoriesList, bauxList, permissionIndex] = await Promise.all([
          fetchLots(params),
          fetchBiens(params),
          fetchCategories(),
          fetchBaux(params),
    ...
    <div>
      ...
      <div className={styles.section}>
        <div className={styles.statsGrid}>
          <StatCard icon="bi-grid-3x3-gap-fill" tone="primary" label={t("bo.agenceLots.title")} value={stats.total} />
      ...
      <div className={styles.section} style={{ marginBottom: 0 }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <h2 className={styles.sectionTitle}>
              ...
              {t("bo.agenceLots.title")}
            </h2>
            <p className={styles.sectionSubtitle}>
              {t("bo.agenceLots.subtitle", { shown: filteredLots.length, total: lots.length })}
            </p>
          </div>
        ...
        {biens.length === 0 && (
          <div className={styles.prereqNotice}>
            ...
            <span className={styles.prereqNoticeText}>{t("bo.agenceLots.noBienAvailable")}</span>
          </div>
        )}
