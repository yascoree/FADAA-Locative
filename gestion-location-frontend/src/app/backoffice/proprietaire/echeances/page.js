    ...
    <div>
      ...
      <div className={styles.section}>
        <div className={styles.statsGrid}>
          <StatCard icon="bi-calendar-check-fill" tone="primary" label={t("bo.proprietaireEcheances.statTotal")} value={stats.total} />
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <h2 className={styles.sectionTitle}>
              ...
              {t("bo.proprietaireEcheances.title")}
            </h2>
            <p className={styles.sectionSubtitle}>
              {t("bo.proprietaireEcheances.subtitle", { shown: filteredEcheances.length, total: echeances.length })}
            </p>
          </div>
        </div>
                      ...
                      <div className={styles.tableActions}>
                        {e.statut !== ECHEANCE_STATUS.PAYE && (
                          <button
                            ...
                            onClick={() => openPay(e)}
                            title={t("bo.proprietaireEcheances.pay")}
                          >
                        ...
                        {e.statut === ECHEANCE_STATUS.IMPAYE && (
                          <button
                            ...
                            className={styles.iconBtn}
                            onClick={() => openEdit(e)}
                            title={t("bo.proprietaireEcheances.edit")}
                          >
