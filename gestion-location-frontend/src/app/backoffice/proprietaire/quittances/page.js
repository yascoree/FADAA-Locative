...
export default function ProprietaireQuittancesPage() {
    ...
    <div>
      ...
      <div className={styles.section} style={{ marginBottom: 0 }}>
        ...
        <p className={styles.sectionSubtitle}>
          {filteredQuittances.length} quittance(s) affichée(s) sur {quittances.length}. Générées automatiquement à
                  ...
                  <tr key={q.id}>
                    ...
                    <td>
                      <div className={styles.tableActions}>
                        ...
                        {q.statut !== QUITTANCE_STATUS.ANNULEE && (
                          <button
                            type="button"
