...
export default function ProprietaireBiensPage() {
  ...
  useEffect(() => {
    async function init() {
      setIsLoading(true);
      try {
        const [biensList, lotsList] = await Promise.all([fetchBiens(), fetchLots()]);
        setBiens(biensList);
        setLots(lotsList);
      } catch (err) {
    ...
    <div>
      ...
      <div className={styles.section}>
        <div className={styles.statsGrid}>
          <StatCard icon="bi-house-door-fill" tone="primary" label={t("bo.proprietaireBiens.statTotal")} value={stats.total} />
      ...
      <div className={styles.section} style={{ marginBottom: 0 }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <h2 className={styles.sectionTitle}>
              ...
              {t("bo.proprietaireBiens.title")}
            </h2>
            <p className={styles.sectionSubtitle}>
              {t("bo.proprietaireBiens.subtitle", { shown: filteredBiens.length, total: biens.length })}
            </p>
          </div>
        ...
        <div className={styles.filtersRow}>
          <div className={styles.searchFieldWrap}>
            ...
            <input
              type="text"
              placeholder={t("bo.proprietaireBiens.searchPlaceholder")}
              value={search}
              onChange={(e) => {
        ...
        <div className={styles.tableWrap}>
          <table className={styles.table}>
            <thead>
              <tr>
                <th>{t("bo.proprietaireBiens.colBien")}</th>
                  ...
                  <tr key={b.id}>
                    ...
                    <td>
                      <div className={styles.tableActions}>
                        <button type="button" className={styles.iconBtn} onClick={() => setDetailsTarget(b)} title={t("bo.common.seeDetails")}>
