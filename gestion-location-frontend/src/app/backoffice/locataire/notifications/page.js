...
const TYPE_TARGET = {
  [NOTIFICATION_TYPE.PAIEMENT]: "/backoffice/locataire/paiements",
  [NOTIFICATION_TYPE.ECHEANCE]: "/backoffice/locataire/echeances",
  [NOTIFICATION_TYPE.BAIL]: "/backoffice/locataire/bail",
...
export default function LocataireNotificationsPage() {
  ...
  useEffect(() => {
    ...
    // page est ouverte (nouveau message, échéance, etc.) apparaissent sans recharger.
